...
CREATE OR REPLACE PACKAGE Proveedores_Package IS
  ...
  -- Actualizar informaci贸n de un proveedor
  ...
  -- Obtener proveedores con m谩s cotizaciones
...
CREATE OR REPLACE PACKAGE UDisponibles_Package AS
  ...
  --informaci髇 detallada de un material
...
BEGIN
  ...
  LOOP
    ...
    -- Imprimir la informaci贸n del cliente sin compras
    DBMS_OUTPUT.PUT_LINE('Cliente sin Compras:');
    DBMS_OUTPUT.PUT_LINE('C茅dula: ' || cliente_sin_compras.ced_cliente);
...
BEGIN
  ...
  LOOP
    ...
    -- Imprimir la informaci贸n de la factura emitida en el 煤ltimo mes
    DBMS_OUTPUT.PUT_LINE('Factura Emitida en el ultimo Mes:');
    DBMS_OUTPUT.PUT_LINE('Numero: ' || factura_ultimo_mes.num_factura);
    DBMS_OUTPUT.PUT_LINE('C茅dula Cliente: ' || factura_ultimo_mes.ced_cliente);
...
BEGIN
  ...
  LOOP
    ...
    --Imprimir la informaci髇 de la cotizaci髇
    DBMS_OUTPUT.PUT_LINE('Cotizaci髇 Vencida:');
...
BEGIN
  ...
  LOOP
    ...
    -- Imprimir la informaci髇 del cliente
    DBMS_OUTPUT.PUT_LINE('Cliente con M醩 Compras:');
    DBMS_OUTPUT.PUT_LINE('C閐ula: ' || cliente.ced_cliente);
