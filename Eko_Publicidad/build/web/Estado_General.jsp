  ...
  <div>
    <div class="fullNav shadow bg-white rounded">
      ...
      <div class="navbar-brand">
        <!--<a href="#">
          <img src="#" alt="EkoPublicidadCR" width="150" height="110">
        </a>-->
        <h1>Eko Publicidad CR</h1>
      </div>
      <!--<a href="/Layout/Cotizacion.html" class="ButtonInicio">-->
      <a href="#" class="ButtonInicio">
      ...
      <a href="#" class="shopCart ButtonInicio">
...
<center>
  ...
  <div>
      <table class="tablaEG" border="1">
          <thead class="theadEG">
              <tr>
                  <th scope="col">SKU Producto</th>
                  <th scope="col">Descripción</th>
                  <th scope="col">En combo</th>
                  <th scope="col">Unidades en inventario</th>
                  <th scope="col">Valor total unidades</th>
          ...
          <tbody>
            <c:forEach var="dato" items="${datos}">
              <tr>
                  ...
                  <td>${dato.getEs_combo()}</td>
                  <td>${dato.getUnidades_disponibles()}</td>
                  <td>${dato.getValor_total()}</td>
                  <td>
                      <form>
...
<footer class="bg-dark text-center text-white">
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2023 Copyright: Eko-Publicidad CR
  </div>
</footer>
